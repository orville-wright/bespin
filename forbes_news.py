...
if __name__ == "__main__":
    ...
    async def test_forbes_news():
        logging.info("Testing Forbes News Extractor...")
        forbes_extractor = forbes_news(1)
        await forbes_extractor.craw4ai_str_schema_extr()
        logging.info(f"Extracted {len(forbes_extractor.DB_insert_data)} Forbes news items")
        
    asyncio.run(test_forbes_news())