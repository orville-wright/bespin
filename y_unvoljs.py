...
# method #1
    def get_un_vol_data(self):
        ...
        with self.js_session.get("https://query1.finance.yahoo.com/v1/finance/screener/predefined/saved?count=200&formatted=true&scrIds=unusual_volume_stocks&sortField=fiftytwowkpercentchange", stream=True, headers=self.yf_headers, cookies=self.yf_headers, timeout=5 ) as self.js_resp2:
