...
class investing_news:
    """
    Class to crawl data from Investing.com via Crawl4ai
    ...
    async def craw4ai_str_schema_extr(self):
        ...
        # WARN: Each url must match the JSON schema in: INVESTING_crawl4ai_schema.json or the
        ...
        logging.info(f"{cmi_debug} - complete Investing.com data crawl/scrape" )
...
if __name__ == "__main__":
    ...
    async def test_investing_news():
        logging.info("Testing Investing.com News Extractor...")
        investing_extractor = investing_news(1)
        await investing_extractor.craw4ai_str_schema_extr()
        logging.info(f"Extracted {len(investing_extractor.DB_insert_data)} Investing.com news items")
