...
def quoute_examples():
    ...
    if args['alpaca_symbol'] is not False:
        ...
        params = {
            ...
            'month': '2026-07',          # Optional: specify a month for historical data
            'interval': 'weekly',        # Data point frequency (daily, weekly, monthly, etc.)
    ...
    if args['alpaca_bars'] is not False:
        ...
        try:
            ...
            bars_df = alpaca.get_bars(bars_symbol, timeframe="10Min", limit=bars_limit)
